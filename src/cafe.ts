import { Course, Nutrition, MenuItem, ComboDeal, OrderLine, MenuItemPartial, kitchenTicket, allergyCard } from './menuTypes';


// Menu

//Defining the menu items soup, risotto, and brownie 
const soup: MenuItem = {
    id: 1,
